        ...
        <div className="container">
          <div className="row position-relative align-items-center">
            <div
              ...
              data-aos-delay="500"
            >
              <h1 className="font-size-8 mb-8 pr-md-20 pr-lg-0" style={{ color: '#4cae9b',fontSize:'20px',fontStyle:'Neue Haas Grotesk Display Pro Roman' }}>
              Hire Sustainability, Climate Tech, ESG
              Professionals For Your Next Project

              </h1>

              <h1 className="font-size-8 mb-8 pr-md-20 pr-lg-0" style={{ color: '#2b2b2b',fontSize:'20px',fontStyle:'Neue Haas Grotesk Display Pro Roman' }}>
