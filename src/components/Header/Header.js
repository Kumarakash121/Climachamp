        ...
        >
          <nav className="navbar site-navbar offcanvas-active navbar-expand-lg px-0 py-0">
            ...
            <div className="brand-logo d-flex">
              ...
              <p style={{fontSize:'24px',color:'#4cae9b',fontStyle:'Neue Haas Grotesk Display Pro Roman',fontWeight: 'bold',}}>Clima</p><p style={{fontSize:'24px',color:'#2b2b2b',fontStyle:'Neue Haas Grotesk Display Pro Roman',fontWeight: 'bold',}}>Champion</p>
            </div>
            </Link>
