          ...
          <div className="container">
            ...
            <div className="row justify-content-center">
              <div className="col-12 dark-mode-texts">
                <div className="mb-9">
                  <Link to="/recommended" className="d-flex align-items-center ml-4">
                    {" "}
...
<div>
      ...
      {selectedOption === "option1" && (
        <div>
          {/* Elements to show when Option 1 is selected */}
          <div style={containerStyle}>
          <p className="mr-10" style={{color:'white'}}>Pay fixed price for this job</p>
          
          <p style={dollarSignStyle}>$</p>
    ...
    <div>
      ...
      <div>
        <label>
          <input
            ...
            onChange={handleChange}
          />
          Deposit lesser amount to cover first milestone

        </label>
      </div>
      <div style={containerStyle}>
      <p style={dollarSignStyle}>Due Date</p>
      <input type='text' style={inputStyle} />
       </div>
        </div>
      )}
      ...
      {selectedOption === "option2" && (
        <div>
          {/* Elements to show when Option 2 is selected */}
          <p>Payment frequency is Each Week
            </p>
            <div style={containerStyle}>
            <p style={{color:'white'}}>Pay per hour price for this job</p>
            
      <p style={dollarSignStyle}>$</p>
      <input type='text' style={inputStyle} />
      <p style={{color:'white'}}>per hour</p>
    </div>
    <div style={containerStyle}>
    <p style={dollarSignStyle}>Due Date</p>
      <input type='text' style={inputStyle} />
